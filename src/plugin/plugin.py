...
delay_choices = [(i, _ngettext("%d millisecond", "%d milliseconds", i) % i) for i in list(range(0, 3100, 100))]  # noqa: F821
...
def menu(menuid, **kwargs):
	return [(_("ServiceApp"), main, "serviceapp_setup", None)] if menuid == "rec" else []
